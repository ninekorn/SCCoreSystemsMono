...
namespace SCMonoAB3DOVR
{
    ...
    /// </summary>
    public class Game1BACKTOBAse : Microsoft.Xna.Framework.Game
    {
        [DllImport("gdi32.dll")]
        public static extern bool DeleteObject(IntPtr hObject);

        Game1BACKTOBAse currentWindow;
        ...
        protected override void Initialize()
        {
            ...
            Vector3 cameraTarget = new Vector3(0.0f, 0.0f, -1); // Look back at the origin
                ...
                for (int eyeIndex = 0; eyeIndex < 2; eyeIndex++)
                {
                    ...
                    for (int textureIndex = 0; textureIndex < textureSwapChainBufferCount; textureIndex++)
                    {
                        ...
                        eyeTexture.RenderTargetViewsXNA[textureIndex] = new RenderTarget2D(GraphicsDevice,
                                                                                            ...
                                                                                            false,
                                                                                            surfaceFormat,
                                                                                            depthFormat, 1, usage, false, 1);



                        //eyeTexture.RenderTargetViewsXNA[textureIndex] = RenderTarget2D.from
                    }
            ...
            {               
                ...
                for (int eyeIndex = 0; eyeIndex < 2; eyeIndex++)
                {
                    ...
                    */
                    ...
                    //base.Draw(gameTime);
                    result = OVR.CommitTextureSwapChain(sessionPtr, eyeTexture.SwapTextureSet.TextureSwapChainPtr); //eyeTexture.RenderTargetViewsXNA[textureIndex].GetNativeDxResource()
        ...
        void DrawEyeViewIntoBackbuffer(int eye)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.Draw(renderTarget[0], new Microsoft.Xna.Framework.Rectangle(offset, 0, width, height), Microsoft.Xna.Framework.Color.White); //eyeTextures[0].Textures[0]
            spriteBatch.End();
        }
