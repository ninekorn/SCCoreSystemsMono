...
namespace JitterDemo.Primitives3D
{
    ...
    /// </summary>
    public class ChunkPrimitive : MeshPrimitive
    {
        /// <summary>
        /// Constructs a new cube primitive, using default settings.
        /// </summary>
        /*public ChunkPrimitive(GraphicsDevice graphicsDevice, Vector3 chunkPosition, sccsplanetchunk _chunk)//GraphicsDevice graphicsDevice)
            : this(graphicsDevice, chunkPosition, _chunk) //this(game, graphicsDevice, chunkPosition, _chunk)//
        {

        }*/

/*public ChunkPrimitive(GraphicsDevice graphicsDevice, Vector3 chunkPosition, sccsplanetchunk _chunk) //Game game, GraphicsDevice graphicsDevice, Vector3 chunkPosition, sccsplanetchunk _chunk
 : this(Demo, graphicsDevice, chunkPosition, _chunk)
{
...
/// </summary>
public ChunkPrimitive(GraphicsDevice graphicsDevice, Vector3 chunkPosition, sccsplanetchunk _chunk)//(GraphicsDevice graphicsDevice,Vector3 position, sccsplanetchunk _chunk) //: this(graphicsDevice, 1, position, _chunk)
{
    float size = 1;
    ...
    AddWorldMatrix(Matrix.Identity);
}
}
}*/
...
namespace JitterDemo.Primitives3D
{
    ...
    /// Geometric primitive class for drawing cubes.
    /// </summary>
    public class ChunkPrimitive : MeshPrimitive // : DrawableGameComponent// : GeometricPrimitive
    {
        ...
        /// Constructs a new cube primitive, using default settings.
        /// </summary>
        public ChunkPrimitive(GraphicsDevice graphicsDevice, Vector3 chunkPosition, sccsplanetchunk _chunk) //: base(game) //(GraphicsDevice graphicsDevice,Vector3 position, sccsplanetchunk _chunk) //: this(graphicsDevice, 1, position, _chunk)
        {

            //effect = JitterDemo.currentWindow.Content.Load<Effect>("Effect/ShaderChunk");
            //texture = JitterDemo.currentWindow.Content.Load<Texture2D>("Texture/texWhite");
        ...
        public void Draw(Matrix view, Matrix projection) //BasicEffect effect, 
        {
            ...
            if (vertices.Count > 0)
            {
                ...
                JitterDemo.currentWindow.GraphicsDevice.Indices = indexBuffer;
