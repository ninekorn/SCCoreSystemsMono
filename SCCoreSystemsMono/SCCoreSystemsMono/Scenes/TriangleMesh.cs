...
namespace JitterDemo.Scenes
{
    public class TriangleMesh : Scene
    {
        ...
        public override void Draw(GameTime gameTime, Matrix view, Matrix projection, int eye) ///override
        {
            ...
            Demo.GraphicsDevice.BlendState = Microsoft.Xna.Framework.Graphics.BlendState.Opaque;
            Demo.GraphicsDevice.DepthStencilState = Microsoft.Xna.Framework.Graphics.DepthStencilState.Default;
        ...
        public override void Build()
        {
            ...
            body.Mass = 100;
            body.Material.Restitution = 0.01f;
            Demo.World.AddBody(body);

            car = AddCar(new JVector(0, 3, 10));
        }
